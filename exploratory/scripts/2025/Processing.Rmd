...
DO.combined <- DO.combined %>%
  select()

ppi_P188_34 <- ppi_P188_34 %>%
  select()
```
...
write.csv(ppi_P188_34,"T:/Labs/Spakowicz/ppiio/data/derived/2025-02-17/P188_formatted_Stage_34.csv" )
```
