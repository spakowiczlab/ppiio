...
heat.plot <- heat.data %>%
  ggplot(aes(meds, fct_relevel(cancer, 'Other', 'melanoma', 'non-small cell lung cancer', 'renal cell carcinoma', 'Sarcoma', 'bladder cancer', "small cell lung cancer", "Hodgkin lymphoma", "colon cancer", "Prostate", "pancreatic cancer", "merkel cell carcinoma", "breast cancer", "head and neck carcinoma", "All"))) +
  ...
  scale_y_discrete(breaks = c('Other', 'melanoma', 'non-small cell lung cancer', 'renal cell carcinoma', 'Sarcoma', 'bladder cancer', "small cell lung cancer", "Hodgkin lymphoma", "colon cancer", "Prostate", "pancreatic cancer", "merkel cell carcinoma", "breast cancer", "head and neck carcinoma", "All"), 
                   labels = c('Other', 'melanoma', 'non-small cell lung cancer', 'renal cell carcinoma', 'Sarcoma', 'bladder cancer', "small cell lung cancer", "Hodgkin lymphoma", "colon cancer", "Prostate", "pancreatic cancer", "merkel cell carcinoma", "breast cancer", "head and neck carcinoma", "All"))
heat.plot
```
