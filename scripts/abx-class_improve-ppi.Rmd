...
load("T:/Labs/Spakowicz/data/exoio/db-meds.RData")
db <- read.csv("T:/Labs/Spakowicz/data/exoio/format_output.csv")


# This should be in T drive
comorb <-read_excel("T:/Labs/Spakowicz/data/exoio/CharlsonScore_Presley_08272019 acj.xlsx", sheet = 2)
...
# This should be in T drive 
steroids <- readRDS("T:/Labs/Spakowicz/data/exoio/steroids_validate.RDS")
...
deidentdb2 <- db2 %>%
  ...
  left_join(irae_time) %>%
  dplyr::select(-record_id, -last_name, -dob,
                # -iostart, 
                -contains("date")
                )


saveRDS(deidentdb2, "../../manuscript/data/from_processing/deidentdb_timing.RDS")
