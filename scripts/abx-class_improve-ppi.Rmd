...
deidentdb2 <- db2 %>%
  ...
  dplyr::select(X, race, sex, age, bmi.calc, vitalstatus, ecog, comorb.score, cancer, cancer.name, staging, abxdays.to.iostart, sterdays.to.start, ppidays.to.iostart, days)
