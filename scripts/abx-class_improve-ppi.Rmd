...
noio <- c(900489173, 980119036, 980187416, 980374070, 980412602, 980495473, 980524866, 980526132, 980543006, 980546304, 980607566, 980622068, 900435346, 907268666, 980360074, 980282827, 980450586, 907227211, 907447227, 900215730, 980484225, 907178894, 970337309, 907897766, 908280483, 980281409, 970014582, 907134292, 980346747, 906232022, 980445076, 908104037, 980465933, 907777800, 980074180, 908177110, 980081274, 908058264, 900516135, 907613047, 980327382, 980398704)
...
deidentdb2 <- db2 %>%
  ...
  left_join(irae_time) %>%
  left_join(ppi_iostart) 

# %>%
#   # I need to remove this chunk and wipe from github. 
#   dplyr::select(-contains("_id"), -contains("date"), -contains("_stop"), -contains("_start"), -last_name, -dob, -lastcontact, -lft_onset, -typeafter, -radiation_baseline1, -bisphosphstart, -bisphosphend, -steroidsend, -steroidsstart, -iostart, -cbc_next, -rash_onset)
